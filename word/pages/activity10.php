...
<div class="page-content">
    ...
    <div class="content-wrapper">
        <?php startActivityPanel('Activity 10: Listen and Record', 'Listen, record your voice, and submit.'); ?>
            <div class="panel-content-wrapper">
                <div class="panel-left">
                    ...
                    <div class="record-controls">
                        <span id="recIndicator" style="display: none;">[ <span class="rec-dot"></span>REC ]</span>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (viewRecordingsBtn) {
        viewRecordingsBtn.addEventListener('click', async function() {
            const currentWord = wordData[currentIndex].english;
            const response = await fetch(`<?php echo BASE_PATH; ?>get-recordings.php?word=${currentWord}`);
