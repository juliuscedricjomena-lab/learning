...
$data = [
    [
        'id' => 1,
        'word' => 'weather',
        'description' => 'What is weather?'
    ],
    [
        'id' => 2,
        'word' => 'satellites',
        'description' => 'What is satellites?'
    ],
    [
        'id' => 3,
        'word' => 'temperature',
     ...
     [
        'id' => 4,
        'word' => 'humidity',
        'description' => 'What is humidity?'
    ],
    [
        'id' => 5,
        'word' => 'atmosphere',
        'description' => 'What is the atmosphere?'
    ],
    [
        'id' => 6,
        'word' => 'precipitation',
        'description' => 'What is precipitation?'
    ],
     [
        'id' => 7,
        'word' => 'wind',
        'description' => 'What is wind?'
    ],
    [
        'id' => 8,
        'word' => 'climate',
        'description' => 'What is climate?'
    ],
    [
        'id' => 9,
        'word' => 'forecast',
        'description' => 'What is a forecast?'
    ],
    [
        'id' => 10,
        'word' => 'storm',
        'description' => 'What is a storm?'
    ]
];
?>
        ...
        <?php startActivityPanel('Activity 7: Sentence Awareness', 'Read the sentence carefully.'); ?>
            <div class="panel-content-wrapper">
                <div class="panel-left">
                    <div class="word-card h100p padding-10" id="wordCard">
                        <div class="word-card-text border-radius-35">
                            <div class="word-sentence" id="wordDescription">
