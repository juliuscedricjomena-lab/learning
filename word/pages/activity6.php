        ...
        <?php startActivityPanel('Activity 6: Sound Mapping', 'Listen and choose the korean meaning.'); ?>
            <div class="panel-content-wrapper">
                <div class="panel-left">
                    <div class="word-card h70p padding-10" id="wordCard">
                        <div class="word-card-text border-radius-35">
                            <div class="header-word" id="baseWord"><?php echo $data[0]['word']; ?></div>
                            <button class="play-word-btn" id="playWordBtn">
                                <img src="<?php echo BASE_PATH; ?>images/icons/eye-icon.png" alt="Eye" class="play-word-icon">
                                <span>Play</span>
                            </button>
                        </div>
                    </div>
