...
$data = [
    [
        ...
        'question' => 'What is the author’s main message in this article, and do you agree or disagree with it? Explain your reasoning with examples from the listening.',
    ...
    [
        'id' => 2,
        'image' => 'images/gallery/image1.png',
        'audio' => 'audio/how-meteorologists-predict-weather.mp3',
        'question' => 'What is the author’s main message in this article, and do you agree or disagree with it? Explain your reasoning with examples from the listening.',
    ...
    [
        'id' => 3,
        'image' => 'images/gallery/image1.png',
        'audio' => 'audio/weather-forecasting.mp3',
        'question' => 'What is the author’s main message in this article, and do you agree or disagree with it? Explain your reasoning with examples from the listening.',
...
<div class="page-content">
    ...
    <div class="content-wrapper">
        <?php startActivityPanel('Activity 2: Critical Listening', 'Listen and tell me how you understand it.'); ?>
            <div class="panel-content-wrapper">
                <div class="activity-content-flex">
                    <div class="activity-image-container" style="flex: 0 0 50%;">
                        ...
                        <div class="image-question-overlay"><?php echo $data[0]['question']; ?></div>
                        <audio id="activityAudio" src="<?php echo BASE_PATH . $data[0]['audio']; ?>"></audio>
                    </div>
                    <div class="listening-content-container" style="flex: 0 0 50%;">
...
function updateWord(index) {
    ...
    const questionOverlay = document.querySelector('.image-question-overlay');
    ...
    if (activityImage && sentenceDescription && wordData[index]) {
        ...
        if (questionOverlay) {
            questionOverlay.textContent = wordData[index].question;
        }
