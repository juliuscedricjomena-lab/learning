            ...
            <div class="panel-content-wrapper">
                <div class="activity-content-flex">
                    ...
                    <div class="sentence-description">
                        <div class="sentence-display" id="sentenceDisplay"><?php echo $data[0]['sentences'][0]['subject'] . ' | ' . $data[0]['sentences'][0]['predicate'] . ' | ' . $data[0]['sentences'][0]['modifier']; ?></div>
